...
It also considers traffic conditions to suggest nearby private parking when public parking is congested.

This project is built as part of an academic project using Python (Flask) and SQLite.
